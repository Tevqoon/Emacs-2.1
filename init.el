...
(defun meow-setup ()
  "My meow setup."
  ;; MOTION state: used in Info, Dired, Magit, etc.
  ;; Deliberately minimal — let special modes keep their own bindings.
  ...
  (meow-normal-define-key
   ...
   ;; ── Character movement (C-f/b/n/p mnemonics) ────────
   '("f" . meow-right)
   '("F" . meow-right-expand)
   '("b" . meow-left)
   '("B" . meow-left-expand)
   ...
   ;; ── Search / navigation ─────────────────────────────
   ;; / sets regexp target, S hops to next occurrence, ; reverses
   '("/" . meow-visit)
   '("s" . meow-search)
   '(";" . meow-reverse)
   '("t" . meow-till)
   ...
   ;; ── Misc ────────────────────────────────────────────
   '("X" . meow-quit)
   '("e" . nil) ;; placeholder — free this up for whatever you want
   '("'" . repeat)
   '("<escape>" . ignore)))
