...
while read -r line; do
	...
	elisp_expr="(base64-encode-string (encode-coding-string (or (mcp-server-lib-process-jsonrpc (decode-coding-string (base64-decode-string \"$base64_input\") 'utf-8) \"$SERVER_ID\") \"\") 'utf-8 t) t)"
